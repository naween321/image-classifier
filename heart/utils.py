...
def get_cropped_image_if_2_eyes(image_path, image_base64_data):
    ...
    face_cascade = cv2.CascadeClassifier('/home/ubuntu/imgclassifier/app/heart/opencv/haarcascades/haarcascade_frontalface_default.xml')
    ...
    eye_cascade = cv2.CascadeClassifier('/home/ubuntu/imgclassifier/app/heart/opencv/haarcascades/haarcascade_eye.xml')
...
def load_saved_artifacts():
    ...
    with open("/home/ubuntu/imgclassifier/app/heart/dataset/test/class_dictionary.json", "r") as f:
    ...
    if __model is None:
        ...
        with open("/home/ubuntu/imgclassifier/app/heart/dataset/test/saved_model.pkl", "rb") as f:
            __model = joblib.load(f)
    print("loading saved artifacts...done")


def get_b64_test_img():
...
if __name__ == '__main__':
    ...
    print(classify_image(get_b64_test_img(), None))
